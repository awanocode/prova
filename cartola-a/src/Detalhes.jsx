...
function Detalhes() {
    ...
    const fetchClube = async () => {
      try {
        const response = await axios.get(
          `https://api.cartola.globo.com/clubes/${id}`
        )
  ...
  return (
    <>
      <h1>{clube.nome}</h1>
      <p>
        <strong>Abreviação:</strong> {clube.abreviacao}
      </p>
      <p>
        <strong>Apelido:</strong> {clube.apelido}
      </p>
      <p>
        <strong>Nome Fantasia:</strong> {clube.nome_fantasia}
      </p>
